...
public class GetReviewResponseBuilder {
    ...
    public static GetReviewResponse build1() {
        return new GetReviewResponse(15L, 15L, 5, "리뷰 15 내용", "/image.png", LocalDateTime.parse("2024-12-01 10:20:30.014", dateTimeFormatter));
    }

    public static GetReviewResponse build2() {
        return new GetReviewResponse(14L, 14L, 4, "리뷰 14 내용", "/image.png", LocalDateTime.parse("2024-12-01 10:20:30.013", dateTimeFormatter));
    }
